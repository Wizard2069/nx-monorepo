...
class AppE2EE {
  ...
  Future<void> generateKeys() async {
    ...
    if (derivedBitsString.isNotEmpty && derivedBitsString != '') {
    ...
    Map<String, dynamic> publicKeyJwk = await keyPair.publicKey.exportJsonWebKey();
    Map<String, dynamic> privateKeyJwk = await keyPair.privateKey.exportJsonWebKey();
